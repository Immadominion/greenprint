 ...
 * only in the team's private Google Doc (the defense guide). Names + roles are
 * enough for the app and the public documentation.
 */
...
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  { id: "nwali-izuchukwu", name: "Nwali Izuchukwu Hosea", display: "Izuchukwu Nwali", email: "izuchukwu.nwali@greenprint.demo", role: "Landing, Green Features & Deployment", seedXp: 300, seedStreak: 1 },
];
